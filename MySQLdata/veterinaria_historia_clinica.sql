...
CREATE TABLE `historia_clinica` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mascota_id_idx` (`mascota_id`),
  CONSTRAINT `fk_mascota_id` FOREIGN KEY (`mascota_id`) REFERENCES `mascota` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `historia_clinica` VALUES (4,1,2020),(5,2,2020);
